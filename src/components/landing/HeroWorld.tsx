...
const copy = {
  ...
  ru: {
    ...
    cta2: "Смотреть демо",
    trust: ["Без обязательств", "Запуск за 7 дней", "Поддержка 24/7"],
    urgency: "⚡ Осталось всего 3 места в этом месяце",
    stats: [
      { value: 127, suffix: "%", label: "Больше лидов" },
      { value: 15, suffix: "ч", label: "Экономия / неделя" },
      { value: 7, suffix: " дн", label: "Полная настройка" },
    ],
  },
  de: {
