...
const COPY={es:{eyebrow:"Desarrollo web orientado a negocio",title:"La infraestructura digital que convierte conversaciones en resultados.",description:"Diseñamos webs, aplicaciones y paneles conectados con la operación real de tu empresa. Construimos el sistema que capta, organiza y mueve el trabajo.",bullets:["Diseño responsive y optimizado para conversión","SEO técnico y estructura escalable","Conexión con formularios, CRM, reservas y pedidos","Automatizaciones y agentes integrados desde el inicio"],projects:"Ver proyectos",contact:"Cuéntanos tu proyecto",connected:"Todo conectado",connectedDetail:"Web, conversación, datos y automatización en una sola arquitectura.",items:[["Webs corporativas","Posicionamiento, captación y conversión."],["E-commerce","Catálogo, pedidos y pagos."],["Aplicaciones y paneles","Herramientas internas y control operativo."],["Integraciones","Datos, CRM, automatizaciones y APIs."]]},
      ...
      <div className="grid items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div className="relative">
          ...
          <div className="relative mx-auto mt-10 flex max-w-md items-center gap-4 rounded-2xl border border-primary/20 bg-background/70 p-4 shadow-xl backdrop-blur">
            ...
            <div>
              <p className="text-sm font-semibold text-foreground">{copy.connected}</p>
              <p className="text-xs text-muted-foreground">{copy.connectedDetail}</p>
            </div>
          </div>
        </div>
      </div>
