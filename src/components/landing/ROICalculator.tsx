...
export const ROICalculator = () => {
  ...
  const content = {
    ...
    ru: {
      title: "Рассчитайте ROI от ИИ-автоматизации",
      subtitle: "Узнайте, сколько вы сэкономите, автоматизировав ручные задачи",
      horasLabel: "Сколько часов в неделю вы тратите на повторяющиеся ручные задачи?",
      horasSuffix: "часов/неделя",
      precioLabel: "Какова стоимость вашего часа работы? (€)",
      ahorroMensual: "Ожидаемая экономия в месяц",
      ahorroAnual: "Ожидаемая экономия в год",
      roiLabel: "Окупаемость инвестиций через",
      roiSuffix: "месяцев",
      roiAnualLabel: "Годовой ROI",
      ctaText: "Записаться на бесплатную диагностику",
      disclaimer: "* На основе тарифа Starter (997€/мес). Результаты могут отличаться.",
    },
    de: {
