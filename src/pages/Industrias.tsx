...
import { 
  Scissors, Stethoscope, Car, UtensilsCrossed, Home, Building2,
  ArrowRight, MessageSquare, CheckCircle2, Zap
} from "lucide-react";
...
const industries = [
  ...
  },
  {
    id: "clinica",
    icon: Stethoscope,
    title: "Clínica (Fisio, Dental, Podología)",
    ...
    intake: ["Nombre completo", "DNI/NIE", "Tipo de consulta", "Profesional preferido", "Seguro médico"],
    conversation: {
      client: "Necesito cita con el fisio para dolor de espalda",
      bot: "Hola! Para dolor de espalda te recomiendo sesión de valoración (45min). Tenemos hueco el lunes 15:00 o miércoles 10:00. ¿Cuál te viene mejor?",
      client2: "Miércoles",
  ...
  },
  {
    ...
    intake: ["Nombre", "Matrícula", "Tipo de vehículo", "Servicio necesario", "Urgencia"],
    conversation: {
      ...
      bot2: "Perfecto, Golf VII. Tenemos 205/55 R16 desde 65€/ud montados. ¿Te viene bien traerlo mañana a las 9:00? En 1h lo tienes.",
    },
  ...
  },
  {
    ...
    title: "Restaurante (Reservas y FAQ)",
    ...
    intake: ["Nombre", "Fecha y hora", "Número de personas", "Preferencias (terraza, interior)", "Alergias/intolerancias"],
    conversation: {
      ...
      bot2: "Perfecto! Mesa para 4, sábado 22:00, terraza. ¿A qué nombre? También dime si hay alguna alergia o preferencia.",
    },
  ...
  },
  {
    ...
    intake: ["Tipo de servicio", "Dirección", "Descripción del problema", "Urgencia", "Fotos (opcional)"],
    conversation: {
      client: "Tengo una fuga de agua en el baño, es urgente",
      bot: "Entendido, fuga urgente. ¿Puedes enviarme una foto? Tenemos un fontanero disponible en las próximas 2h. ¿Tu dirección?",
      client2: "[foto] Calle Mayor 15, 3º",
      bot2: "Recibido. Juan (fontanero) llegará entre 16:00-17:00. Te avisará 15min antes. Coste de desplazamiento: 25€ + diagnóstico gratis.",
    },
  ...
  },
  {
    ...
    intake: ["Nombre", "Email", "Tipo de propiedad", "Presupuesto", "Zona preferida", "Fecha entrada (vacacional)"],
    conversation: {
      client: "Busco piso de 2 hab en centro, máximo 900€/mes",
      bot: "¡Hola! Tenemos 3 opciones que encajan: 1) C/Sol - 850€ 2) Plaza Mayor - 890€ 3) C/Luna - 875€. ¿Te envío las fichas?",
      client2: "Sí, la de Plaza Mayor",
      bot2: "Aquí tienes la ficha del piso en Plaza Mayor: 75m², 2 hab, reformado 2022, gastos incluidos. ¿Quieres agendar una visita? Tenemos hueco mañana 18:00.",
    },
