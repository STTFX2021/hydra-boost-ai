...
const services: Service[] = [
  {
    icon: Sparkles,
    title: "Creación Web",
    text: "Webs modernas, rápidas y optimizadas para convertir visitantes en clientes.",
    price: "desde 890€",
    time: "5-10 días",
    result: "+35% conversiones",
  },
  {
    icon: Code2,
    title: "Desarrollo Web",
    text: "Aplicaciones y plataformas web a medida, escalables y seguras.",
    price: "a medida",
    time: "2-6 semanas",
    result: "100% escalable",
  },
  {
    icon: Bot,
    title: "Chatbots & IA",
    text: "Asistentes inteligentes que atienden, califican y convierten 24/7.",
    price: "desde 690€",
    time: "7 días",
    result: "+60% leads calificados",
  },
  {
    icon: Zap,
    title: "Automatización",
    text: "Procesos repetitivos automatizados para ahorrar tiempo y dinero.",
    price: "desde 490€",
    time: "7-14 días",
    result: "-15h / semana",
  },
...
const cases = [
  {
    sector: "Restaurante",
    metric: "+62%",
    metricLabel: "reservas por WhatsApp",
    quote: "En un mes, Vozra gestionó más reservas que dos camareros juntos.",
    author: "Carlos R.",
    role: "Marbella",
  },
  {
    ...
    metric: "-80%",
    metricLabel: "no-shows en citas",
    quote: "Los recordatorios automáticos nos devolvieron horas de agenda cada día.",
    author: "Ana M.",
    role: "Málaga",
  },
  {
    ...
    quote: "El chatbot filtra antes de que llegue a nosotros. Cerramos más rápido.",
    author: "David L.",
    role: "Costa del Sol",
  },
];
...
const faqs = [
  {
    ...
    a: "La mayoría de proyectos están en producción en 7 días. Desarrollos a medida requieren de 2 a 6 semanas según alcance.",
  },
  {
    q: "¿Tengo permanencia o contrato mínimo?",
    a: "No. Trabajamos sin permanencia. Puedes pausar o cancelar cuando quieras.",
  },
  {
    q: "¿Cuánto cuesta empezar?",
    a: "Desde 490€ el primer proyecto. La auditoría inicial de 30 minutos es totalmente gratuita y sin compromiso.",
  },
  {
    q: "¿Con qué herramientas os integráis?",
    a: "WhatsApp, Twilio, HubSpot, Google Calendar, Ringover, Zapier, Make, Stripe, Meta, OpenAI y prácticamente cualquier API abierta.",
  },
  {
    q: "¿Los datos son míos?",
    a: "Sí. Toda la información generada, conversaciones y modelos entrenados quedan bajo tu propiedad. Cumplimos con RGPD.",
  },
  {
    q: "¿Ofrecéis soporte después del lanzamiento?",
    a: "Sí. Todos los planes incluyen soporte técnico, mejoras continuas y monitorización proactiva.",
  },
];
...
const Index = () => (
  <>
    <SEOHead
      ...
      description="Mejora y agiliza tu negocio con IA en 7 días. Chatbots, agentes de voz y desarrollo a medida por profesionales, para profesionales."
      canonical="/"
    />
    <OrganizationSchema />
    <LocalBusinessSchema />
      ...
      <main>
            ...
            >
              ...
              >
                ...
                <p className="mt-3 text-sm leading-6 text-zinc-300">
                  "Perfecto, Laura. Reserva para 4 personas confirmada."
                </p>
              </motion.div>
        ...
        <section id="sentra" className="section-container py-24">
            ...
            <div className="space-y-4">
              {sentraLeft.map(([Icon, title, text]) => (
                <motion.article
                  {...fadeUp}
                  key={title}
                  className="rounded-xl border border-white/15 bg-zinc-950/80 p-5 transition hover:border-cyan-300/40 hover:bg-zinc-950"
                >
          ...
          <motion.div
            ...
            style={{
              background:
                "linear-gradient(135deg, rgba(34,211,238,0.55), rgba(34,211,238,0.05) 40%, rgba(34,211,238,0.4))",
            }}
          >
              ...
              <div className="relative grid items-center gap-10 lg:grid-cols-[1.1fr_2fr]">
                <div>
                  ...
                  <img
                    src="/vozra-logo.svg"
                    alt="Vozra"
                    className="mt-4 h-auto max-h-24 w-auto max-w-full object-contain"
                  />
