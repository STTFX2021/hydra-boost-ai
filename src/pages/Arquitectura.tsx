...
export default function Arquitectura() {
  ...
  const content = {
    es: {
      badge: "Arquitectura Enterprise en Vivo", title: "Event Bus &", titleHighlight: "Orchestrators",
      ...
      pauseBtn: "Pausar Simulación", startBtn: "Iniciar Simulación", processing: "Procesando eventos...", paused: "Simulación pausada",
      eventsProcessed: "Eventos Procesados", uptime: "Uptime", activeWorkers: "Workers Activos",
      flowTitle: "Flujo de Eventos en Tiempo Real", liveEventsTitle: "Eventos en Vivo", componentsTitle: "¿Qué hace cada componente?",
      ...
      statusIdle: "En espera", statusProcessing: "Procesando", statusSuccess: "Completado", statusError: "Error",
      events: "eventos", waitingEvents: "Esperando eventos...",
      workflowsBadge: "Workflows Reales", workflowsTitle: "Nuestros Workflows en Acción",
      workflowsSubtitle: "Así conectamos Apify + n8n para ejecutar campañas que generan leads reales. Haz clic en cada nodo para ver qué hace.",
      catalogBtn: "Ver Catálogo de Agentes",
      seoTitle: "Arquitectura IA | HydrAI Labs", seoDesc: "Cómo funciona la arquitectura de automatización IA de HydrAI Labs. Event Bus, Orchestrators y Agentes autónomos.",
      breadcrumbHome: "Inicio", breadcrumbArch: "Arquitectura",
    },
    en: {
