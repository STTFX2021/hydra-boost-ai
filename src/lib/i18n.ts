...
const landingTranslations = {
  ...
  ru: {
    hero: {
      badge: 'Архитектура ИИ-автоматизации',
      title1: 'Архитектуры ИИ-автоматизации',
      title2: 'которые управляют вашим бизнесом 24/7',
      subtitle: 'Мы проектируем целостные системы, объединяющие привлечение клиентов, операции и обслуживание в автономной архитектуре. Мы не продаём разрозненные инструменты — мы строим нервную систему вашей компании.',
      levelQuestion: 'Какой уровень автоматизации вам нужен?',
      baseTitle: 'Базовые внедрения',
      baseFeatures: ['Сайты как узлы привлечения', 'Разговорные агенты', 'Связанные автоматизации'],
      baseCta: 'Смотреть решения',
      enterpriseTitle: 'Enterprise-архитектура',
      enterpriseFeatures: ['Event Bus + оркестраторы', 'Специализированные воркеры', 'Агенты CEO/CFO/CTO'],
      enterpriseCta: 'Смотреть архитектуру',
      ctaPrimary: 'Заказать аудит автоматизации',
      ctaSecondary: 'Смотреть реальные кейсы',
      stats: ['50+ активных воркфлоу', '10K+ событий/мес', '99.9% аптайм'],
      systemActive: 'Система активна, обрабатывает события...',
      eventsPerMin: '↑ 10 событий/мин',
      workersActive: '3 активных воркера',
    },
    base: {
      badge: '🏪 Базовые внедрения',
      title: 'Связанные автоматизации',
      titleHighlight: 'для бизнеса',
      subtitle: 'Мы не продаём разрозненные инструменты. Каждое внедрение — это узел вашей автоматизированной архитектуры, который захватывает, обрабатывает и действует.',
      services: [
        {
          title: 'Профессиональные сайты',
          description: 'Оптимизированные узлы привлечения, связанные с вашей автоматизированной системой.',
          features: ['Лендинг с оптимизацией под конверсию', 'Базовый SEO + умные формы', 'Интеграция с Event Bus', 'Автоматическая аналитика и трекинг'],
          cta: 'Смотреть примеры',
        },
        {
          title: 'Разговорные агенты',
          description: 'Это не простые чат-боты — это агенты, встроенные в вашу архитектуру.',
          features: ['WhatsApp Business + Instagram + сайт', 'Захват, фильтрация и квалификация лидов', 'Автоматическая запись клиентов', 'Подключение к CRM/Supabase'],
          cta: 'Попробовать демо',
        },
        {
          title: 'Оркестрация процессов',
          description: 'Воркфлоу, связывающие инструменты, данные и действия без участия человека.',
          features: ['Лид → CRM → автоматический фоллоу-ап', 'Запись + напоминания + подтверждения', 'Платежи → email → выставление счетов', 'Ежедневные/еженедельные авто-отчёты'],
          cta: 'Смотреть процессы',
        },
      ],
      implementationFrom: 'Внедрение от',
      consult: 'Связаться',
      portfolioTitle: 'Внедрения в реальном бизнесе',
      portfolioItems: [
        { sector: 'Ресторан', desc: 'Сайт + WhatsApp-бот + бронирование' },
        { sector: 'Салон красоты', desc: 'Запись + напоминания + платежи' },
        { sector: 'Профессиональные услуги', desc: 'Lead Engine + CRM + фоллоу-ап' },
      ],
      viewAllCases: 'Смотреть все кейсы →',
    },
    enterprise: {
      badge: '🏢 Enterprise Elite архитектура',
      title: 'Системы автоматизации уровня Enterprise',
      subtitle: 'Event Bus, оркестраторы, специализированные воркеры и автономные C-Level агенты. Архитектуры, обрабатывающие тысячи событий без участия человека.',
      comparisonTitle: 'Разница в подходе Enterprise',
      othersTitle: 'Другие ИИ-агентства',
      usTitle: 'HydrAI Labs Enterprise',
      othersFeatures: [
        'Базовый FAQ-чат-бот (200 ответов)',
        'Изолированные ручные автоматизации',
        'Универсальные шаблоны для всех',
        'Реактивная поддержка (9-18 будни)',
        'Простые ассистенты с жёсткими правилами',
      ],
      usFeatures: [
        'Event Bus обрабатывает 10K+ событий/мес',
        'Центральный оркестратор со специализированными воркерами',
        'Индивидуальные enterprise-архитектуры',
        'SRE Guardian — авто-восстановление 24/7',
        'Автономные агенты CEO, CFO, CTO, Legal',
      ],
      automationsTitle: 'Наши Enterprise-автоматизации',
      automations: [
        { icon: '🧠', title: 'Opportunity Intelligence Engine', features: ['Радар трендов каждые 6 часов', 'Агрессивный скоринг лидов', 'Автоматические продающие сообщения', 'Активный поиск клиентов'], result: '3x конверсия пайплайна' },
        { icon: '⚙️', title: 'Event-оркестратор', features: ['Event Bus обрабатывает 10K+ событий/мес', 'Специализированные воркеры (Leads, OPS)', 'Умная маршрутизация по типу', 'Авто-восстановление P0/P1/P2'], result: '0 простоев, <2 мин' },
        { icon: '👥', title: 'Автономные C-Level агенты', features: ['CEO: стратегия и приоритеты', 'CFO: финансовые решения', 'CTO: технический ресёрч', 'Legal: автоматический комплаенс'], result: '24/7 без блокеров' },
        { icon: '📊', title: 'Master Inventory Analyzer', features: ['Анализ активных воркфлоу', 'Поиск простаивающих ресурсов', 'Ежедневные отчёты о состоянии', 'Оптимизация расходов'], result: '40% снижение затрат' },
        { icon: '🎯', title: 'Lead Intelligence Engine', features: ['Интегрированный мультиканальный intake', 'Автоматическая ИИ-классификация', 'Персонализированный нертуринг', 'Интеграция CRM/Supabase'], result: '70% экономии времени' },
        { icon: '🔧', title: 'SRE Guardian System', features: ['Непрерывный мониторинг 24/7', 'Автоматические health-чеки', 'Умное восстановление', 'Мультиканальные алерты P0/P1/P2'], result: 'Само-восстановление 24/7' },
      ],
      waitlistTitle: 'Записаться в лист ожидания',
      waitlistSubtitle: 'Эксклюзивный доступ для компаний, которым нужны enterprise-архитектуры.',
      waitlistCta: 'Запросить Enterprise-доступ',
    },
    process: {
      title: 'Как мы',
      titleHighlight: 'работаем',
      subtitle: 'Процесс адаптирован под нужный вам уровень архитектуры',
      steps: [
        { num: '1', title: 'Первичный аудит', description: 'Анализируем ваши текущие процессы и выявляем точки автоматизации', time: '30-60 мин (бесплатно)' },
        { num: '2', title: 'Дизайн архитектуры', description: 'Предлагаем конкретную архитектуру с процессами, интеграциями и ожидаемым ROI', time: '2-5 рабочих дней' },
        { num: '3', title: 'Поэтапное внедрение', description: 'Разрабатываем и интегрируем системы модульно и с тестированием', time: '1-4 недели (по объёму)' },
        { num: '4', title: 'Мониторинг и оптимизация', description: 'Сопровождаем систему, корректируем и расширяем по мере необходимости', time: 'Постоянно' },
      ],
    },
    techStack: {
      title: 'Построено на лучших инструментах',
    },
    finalCta: {
      title: 'Готовы увидеть свой бизнес на автопилоте?',
      subtitle: 'Запишитесь на бесплатный аудит — мы покажем, какие процессы можно автоматизировать и какой ROI ожидать.',
      cta: 'Заказать аудит автоматизации →',
      disclaimer: 'Это не продающий звонок. Это реальный технический аудит автоматизируемых процессов.',
    },
  },
  de: {
    hero: {
...
const legacyTranslations: TranslationsType = {
  ...
  ru: {
    ...
    nav: {
      ...
      architecture: 'ИИ-архитектура',
    },
    footer: {
      description: 'Архитектуры ИИ-автоматизации, которые управляют вашим бизнесом 24/7.',
      solutions: 'Решения',
      solutionsBase: 'Базовые внедрения',
      solutionsEnterprise: 'Enterprise-архитектура',
      solutionsCases: 'Сценарии',
      solutionsProcess: 'Процесс',
      resources: 'Ресурсы',
      resourcesBlog: 'Блог',
      resourcesCases: 'Успешные кейсы',
      resourcesFaq: 'FAQ',
      ...
      email: 'hola@hydrailabs.com',
      location: 'Марбелья · Коста-дель-Соль, Испания',
    },
    common: {
      loading: 'Загрузка...',
      error: 'Ошибка',
...
const contactTranslations: Record<Language, ContactCopy> = {
  ...
  ru: {
    badge: 'Контакты',
    heroTitle: 'Расскажите о вашем',
    heroTitleHighlight: 'проекте',
    heroSubtitle: 'Отвечаем менее чем за 24 часа. Без обязательств.',
    ...
    messagePlaceholder: 'Расскажите о вашем бизнесе и о том, что вам нужно...',
    send: 'Отправить сообщение',
    sending: 'Отправка...',
    successPrefix: 'Отлично',
    successSuffix: '! Ответ придёт в течение 24 часов.',
    errorWhatsapp: 'Произошла техническая ошибка. Напишите нам напрямую в WhatsApp:',
    errorWhatsappCta: 'Открыть WhatsApp →',
    discordTitle: 'Discord',
    discordSubtitle: 'Присоединяйтесь к нашему сообществу',
    emailTitle: 'Email',
    locationTitle: 'Локация',
    locationValue: '100% удалённо (Испания)',
    responseTitle: 'Время ответа',
    responseValue: '< 24 рабочих часов',
    auditCardTitle: 'Предпочитаете аудит?',
    auditCardSubtitle: 'Узнайте бесплатно, как ИИ может помочь вашему бизнесу.',
    auditCardCta: 'Бесплатный аудит',
    investorBadge: 'Investor Hub',
    investorTitle: 'Investor Hub',
    investorSubtitle: 'Мы строим системы с потенциалом масштабирования. Станьте партнёром.',
    investorCta: 'Перейти в Investor Hub',
    seoTitle: 'Контакты | HydrAI Labs',
    seoDescription: 'Свяжитесь с HydrAI Labs. Бесплатный аудит автоматизации для вашего локального бизнеса.',
    validationNameShort: 'Имя слишком короткое',
    validationEmailInvalid: 'Неверный email',
    validationMessageShort: 'Сообщение слишком короткое',
    validationFormError: 'Проверьте данные формы',
